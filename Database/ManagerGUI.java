...
JPanel consoleCard = ModernUI.card("", consoleScroll);
    ...
    private void viewAllCustomers() {
        ...
        try (conn) {
            ...
            while (rs.next()) {
                ...
                sb.append("Instagram: ").append(rs.getString("Instagram_user"))
                  .append(" | Email: ").append(rs.getString("Cemail"))
                  .append(" | Phone: ").append(rs.getString("Cphone_number")).append("\n");
                sb.append("Address: ").append(rs.getString("City"))
                  .append(", ").append(rs.getString("Street_name"))
                  .append("\n---------------------------\n");
            }
    ...
    private void runRentalCustomerEquipmentBill() {
        ...
        try (conn) {
            ...
            StringBuilder sb = new StringBuilder("=== RENTAL + CUSTOMER + EQUIPMENT + BILL ===\n");
            boolean found = false;
            ...
            while (rs.next()) {
                ...
                sb.append("Customer: ")
                  ...
                  .append(" (").append(rs.getString("Customer_id")).append(")\n");

                sb.append("Rental #: ").append(rs.getString("Rental_num"))
                  .append(" | Receive: ").append(rs.getString("Receive_datetime"))
                  .append(" | Return: ").append(rs.getString("Return_datetime")).append("\n");

                sb.append("Equipment: ").append(rs.getString("Qname"))
                  .append(" (").append(rs.getString("Equipment_id")).append(")")
                  .append(" | Type: ").append(rs.getString("Type"))
                  .append(" | Qty: ").append(rs.getInt("Equipment_quantity")).append("\n");
                ...
                sb.append("Bill ID: ").append(rs.getString("Bill_id"))
                  ...
                  .append(" | Method: ").append(rs.getString("Payment_method")).append("\n");
    ...
    private void runActiveRentals() {
        ...
        try (conn) {
            ...
            StringBuilder sb = new StringBuilder("=== CURRENT ACTIVE RENTALS ===\n");
            boolean found = false;
            while (rs.next()) {
                found = true;
                sb.append("Customer: ")
    ...
    private void runCustomerSpendingSummary() {
        ...
        try (conn) {
            ...
            StringBuilder sb = new StringBuilder("=== CUSTOMER SPENDING SUMMARY ===\n");
            boolean found = false;
            while (rs.next()) {
                found = true;
                sb.append("Customer: ")
                  ...
                  .append(rs.getString("Lname")).append(" (")
                  .append(rs.getString("Customer_id")).append(")\n");
                sb.append("Total Rentals: ").append(rs.getInt("Total_rentals"))
                  .append(" | Total Items Rented: ").append(rs.getInt("Total_items_rented"))
                  .append(" | Total Money Spent: ").append(rs.getDouble("Total_money_spent"))
                  .append("\n---------------------------\n");
            }
    ...
    private void viewMyBranchInfo() {
        ...
        try (conn) {
            ...
            StringBuilder sb = new StringBuilder("=== MY BRANCH INFO ===\n");
            if (rs.next()) {
                sb.append("Branch ID: ").append(rs.getString("Branch_id")).append("\n")
                  .append("City: ").append(rs.getString("City")).append("\n")
                  .append("Street: ").append(rs.getString("Street_name")).append("\n")
                  .append("Phone: ").append(rs.getString("BPhone_number")).append("\n")
                  .append("Manager ID: ").append(rs.getString("Branch_manager_id"));
            } else {
    ...
    private void viewMyBranchStock() {
        ...
        try (conn) {
            ...
            StringBuilder sb = new StringBuilder("=== BRANCH STOCK (" + managerBranchId + ") ===\n");
            boolean found = false;

            while (rs.next()) {
                found = true;
                sb.append("Equipment ID: ").append(rs.getString("Stock_equipment_id"))
